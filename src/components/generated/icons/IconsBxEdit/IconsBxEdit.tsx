...
export const IconsBxEdit = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`icons-bx-edit ${className}`}
      fill="none"
      height="30"
      viewBox="0 0 30 30"
      width="30"
